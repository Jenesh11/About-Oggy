...
const projects: Project[] = [
  ...
  },
  {
    ...
    // Using a dark dashboard image to match the "Financial Overview" style
...
// Helper to assign vibrant colors to tech badges
const getTechBadgeStyle = (tech: string) => {
  ...
  return 'bg-slate-600 text-white'; // Fallback
};
                ...
                >
                    ...
                    <div className="h-40 bg-slate-200 border-b-4 border-slate-800 relative overflow-hidden group">
                        <img 
                            src={project.image} 
                            alt={project.title} 
                            // Added object-top to ensure the top of the dashboard/screenshot is prioritized
